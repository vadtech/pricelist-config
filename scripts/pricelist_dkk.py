import pandas
colums = ['DKK_Pricelist_ID','DKK_Pricelist Name','DKK_Currency','Product Template ID','Products/ID','Pricelist Rules/Apply On','DKK_item_ids/fixed_price']
...
excel_data_df.to_excel('../generated_pricelists/DKK_pricelist_230307.xlsx',index=True,header=pricelist_column_names)