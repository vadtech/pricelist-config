import pandas
colums = ['DKK rec._Pricelist_ID','DKK rec._Pricelist Name','DKK rec._Currency','Pricelist Rules/Product Variant/ID','Pricelist Rules/Product/ID','Pricelist Rules/Apply On','DKK rec.']
...
excel_data_df.to_excel('../../generated_pricelist/20/DKK rec._pricelist_May.xlsx',index=True,header=pricelist_column_names)