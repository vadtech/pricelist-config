import pandas
colums = ['EUR rec._Pricelist_ID','EUR rec._Pricelist Name','EUR rec._Currency','Pricelist Rules/Product Variant/ID','Pricelist Rules/Product/ID','Pricelist Rules/Apply On','EUR rec.']
...
excel_data_df.to_excel('../../generated_pricelist/20/EUR rec._pricelist_May.xlsx',index=True,header=pricelist_column_names)