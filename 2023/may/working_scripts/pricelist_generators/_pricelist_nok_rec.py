import pandas
colums = ['NOK rec._Pricelist_ID','NOK rec._Pricelist Name','NOK rec._Currency','Pricelist Rules/Product Variant/ID','Pricelist Rules/Product/ID','Pricelist Rules/Apply On','NOK rec.']
...
excel_data_df.to_excel('../../generated_pricelist/20/NOK rec._pricelist_May.xlsx',index=True,header=pricelist_column_names)