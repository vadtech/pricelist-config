import pandas
colums = ['SEK_Pricelist_ID','SEK_Pricelist Name','SEK_Currency','Product Template ID','Products/ID','Pricelist Rules/Apply On','SEK_item_ids/fixed_price']
...
excel_data_df.to_excel('../generated_pricelists/SEK_pricelist_230307.xlsx',index=True,header=pricelist_column_names)